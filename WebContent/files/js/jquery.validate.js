...
$.extend( $.validator, {
	...
	methods: {
        ...
        port:function(value,element){
            return this.optional( element ) || /^[1-9]$|(^[1-9][0-9]$)|(^[1-9][0-9][0-9]$)|(^[1-9][0-9][0-9][0-9]$)|(^[1-6][0-5][0-5][0-3][0-5]$)/.test( value );
        },
